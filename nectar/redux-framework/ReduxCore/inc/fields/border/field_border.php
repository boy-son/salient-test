    ...
    class ReduxFramework_border {
        ...
        function render() {
            ...
            if ( isset( $this->field['all'] ) && $this->field['all'] == true ) {
                echo '<div class="field-border-input input-prepend"><span class="add-on"><i class="el el-fullscreen icon-large"></i></span><input type="text" class="redux-border-all redux-border-input mini ' . esc_attr($this->field['class']) . '" placeholder="' . __( 'All', 'redux-framework' ) . '" rel="' . esc_attr($this->field['id']) . '-all" value="' . esc_attr($this->value['top']) . '"></div>';
            }
            ...
            if ( ! isset( $this->field['all'] ) || $this->field['all'] !== true ) {
                ...
                if ( $this->field['top'] === true ) {
                    echo '<div class="field-border-input input-prepend"><span class="add-on"><i class="el el-arrow-up icon-large"></i></span><input type="text" class="redux-border-top redux-border-input mini ' . esc_attr($this->field['class']) . '" placeholder="' . __( 'Top', 'redux-framework' ) . '" rel="' . esc_attr($this->field['id']) . '-top" value="' . esc_attr($this->value['top']) . '"></div>';
                }
            ...
            if ( $this->field['style'] != false ) {
                ...
                echo '<select original-title="' . __( 'Border style', 'redux-framework' ) . '" id="' . esc_attr($this->field['id']) . '[border-style]" name="' . esc_attr($this->field['name']) . esc_attr($this->field['name_suffix']) . '[border-style]" class="tips redux-border-style ' . esc_attr($this->field['class']) . '" rows="6" data-id="' . esc_attr($this->field['id']) . '">';
            ...
            if ( $this->field['color'] != false ) {
                $default = isset( $this->field['default']['border-color'] ) ? esc_attr($this->field['default']['border-color']) : '';


                if ( empty( $default ) ) {
                    $default = ( isset( $this->field['default']['color'] ) ) ? esc_attr($this->field['default']['color']) : '#ffffff';
                }

                echo '<input name="' . esc_attr($this->field['name']) . esc_attr($this->field['name_suffix']) . '[border-color]" id="' . esc_attr($this->field['id']) . '-border" class="redux-border-color redux-color redux-color-init ' . esc_attr($this->field['class']) . '"  type="text" value="' . esc_attr($this->value['color']) . '"  data-default-color="' . $default . '" data-id="' . esc_attr($this->field['id']) . '" />';
            } else {
